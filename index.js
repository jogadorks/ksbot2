...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=556984423908:+55 69 8442-3608\n' // WhatsApp ID + phone number
            + 'END:VCARD'
prefix = '?'
blocked = []
limitawal = '999999999'
...
function kyun(seconds){
  ...
  return `${pad(hours)} horas ${pad(minutes)} munutos ${pad(seconds)} segundos`
}
...
//DATABASE X
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '556984423608@s.whatsapp.net'
